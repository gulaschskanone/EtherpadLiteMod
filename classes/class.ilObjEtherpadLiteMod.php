...
* $Id$
*/
class ilObjEtherpadLiteMod extends ilObjectPlugin
{
	/**
	* Constructor
	*
	...
	*/
    ...
    protected function isOldEtherpad()
    {
    	...
    	$r = $ilDB->query("SELECT * FROM rep_robj_xct_data ".
	...
	*/
	protected function doCreate()
    {
        ...
        $ilDB->manipulate("INSERT INTO rep_robj_xct_data (id, is_online, epadl_id,show_controls,line_numbers,show_colors,show_chat,monospace_font,show_style,show_list,show_redo,show_coloring,show_heading,show_import_export, show_timeline,old_pad, read_only_id, read_only) VALUES (" .
    ...
    protected function doRead()
    {
        ...
        $set = $ilDB->query("SELECT * FROM rep_robj_xct_data " .
                " WHERE id = " . $ilDB->quote($this->getId(), "integer")
        );
    ...
    protected function doUpdate()
    {
        ...
        $ilDB->manipulate($up = "UPDATE rep_robj_xct_data SET " .
	...
	*/
	function doDelete()
	{
		...
		{
			$ilDB->manipulate("DELETE FROM rep_robj_xct_data WHERE ".
...
/**
     ...
     *
     * @param   integer 			available questions
     */
    public function setAvailableQuestions($a_val)
    {
    	$this->xct_av_questions = $a_val;
    }
    
    /**
     * Get available questions
     *
     * @return    integer 			available questions
     */
    public function getAvailableQuestions()
    {
    	return $this->xct_av_questions;
    }    
     ...
     */
    public function setEagleEyeMail($a_val)
    {
    	$this->xct_eagle_eye_mail = $a_val;
    }
     ...
     */
    public function getEagleEyeMail()
    {
