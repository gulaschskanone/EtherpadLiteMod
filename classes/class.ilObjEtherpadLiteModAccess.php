...
* @version $Id$
*/
class ilObjEtherpadLiteModAccess extends ilObjectPluginAccess
{
	...
	*/
	function _checkAccess($a_cmd, $a_permission, $a_ref_id, $a_obj_id, $a_user_id = "")
	{
		...
		switch ($a_permission)
		{
			case "read":
			case "visible":
				if (!ilObjEtherpadLiteModAccess::checkOnline($a_obj_id) &&
	...
	*/
	static function checkOnline($a_id)
	{
		...
		$set = $ilDB->query("SELECT is_online FROM rep_robj_xct_data ".
